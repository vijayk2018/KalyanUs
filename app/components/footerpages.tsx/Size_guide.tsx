...
export default function SizeGuide() {
    return (
        <div className="bg-white min-h-screen pt-16 pb-24 font-sans">
            <div className="max-w-[1240px] mx-auto px-4 md:px-8">
                ...
                <div className="max-w-[950px] mx-auto text-[#666] text-[15px] leading-relaxed mb-16 space-y-6 text-center">
                    <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1000px] mx-auto">
                    ...
                    {/* Ring Card */}
                    <div className="border border-gray-100 rounded-lg shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] p-6 bg-white transition-shadow hover:shadow-lg">
                        <div className="mb-4">
